...
<main role="main" class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            ...
            <?php 
            $sql = "SELECT posts.id, posts.title, posts.body, posts.created_at, posts.user_id, users.first_name, users.last_name FROM posts LEFT JOIN users ON users.id = posts.user_id ORDER BY created_at DESC";
